...
export const root: VDir = {
  ...
  children: [
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              icon: "image",
              desc: "vance-ad.com",
              src: "/shots/vance-1.png",
              caption: "vance-ad.com — storefront",
            },
            {
              kind: "image",
              name: "store-shop.png",
              icon: "image",
              desc: "vance-ad.com",
              src: "/shots/vance-2.png",
              caption: "vance-ad.com — collection",
            },
            {
              kind: "link",
              name: "adborne.com",
            ...
            {
              kind: "image",
              name: "adborne-title.png",
              icon: "image",
              desc: "adborne.com",
              src: "/shots/adborne-1.png",
              caption: "adborne.com — title screen",
            },
            {
              kind: "image",
              name: "adborne-shop.png",
              icon: "image",
              desc: "adborne.com",
              src: "/shots/adborne-2.png",
              caption: "adborne.com — the drop",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              icon: "image",
              desc: "dreamhouse.nyc",
              src: "/shots/dreamhouse-1.png",
              caption: "dreamhouse.nyc — home",
            },
            {
              kind: "image",
              name: "work.png",
              icon: "image",
              desc: "dreamhouse.nyc",
              src: "/shots/dreamhouse-2.png",
              caption: "dreamhouse.nyc — selected work",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              icon: "image",
              desc: "live site",
              src: "/shots/threejs-1.png",
              caption: "three.js portfolio — scene index",
            },
            {
              kind: "image",
              name: "experiment.png",
              icon: "image",
              desc: "live site",
              src: "/shots/threejs-2.png",
              caption: "three.js portfolio — an experiment",
            },
            {
              kind: "link",
              name: "github",
      ...
      children: [
        {
          ...
          app: "defrag",
          icon: "game",
          desc: "the machine is coming apart. put it back.",
        },
        {
          kind: "app",
          name: "minesweeper",
    ...
    },
    {
      ...
      app: "display",
      icon: "settings",
      desc: "wallpaper controls, wired to the live renderer",
    },
  ],
}
